...
Падинги - это отступы от внутреннего контента до границ самого блока (квадрата) 
*/
'use strict';
...
// offsetWidth - охватывате и бордер и паддинг и полосу прокрутки 
...
// Используя эту тема, можно раскрыть весь наш скролл 
...
// Интересно, как себя ведет правиль Box sizing: border box (вписывается в css) Это правильно включает в себя высоту или ширину элетемнта, падинки и ширину самого контента.
// теперь clienWidth включаетс в себя падинги, но помним, что не включает себя полосу прокрутки. 
...
console.log(box.getBoundingClientRect().left + " Метод получения координат"); // Метод для получения координат. Это метод, ставим круглые скобка в конце.
...
console.log(document.documentElement.clientHeight + " Высота документа"); // высота
...
let widthOffset = box.scrollWidth,
    heightOffset = box.scrollHeight;
