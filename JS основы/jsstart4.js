...
// console.log(str.toLowerCase());// а тут наоброт (помним, это работает только на одну команду консоль, дальше выведешь консоль, текст будет как и был в первоначальной форме)
