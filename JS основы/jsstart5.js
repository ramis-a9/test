...
// arr[0] = 'ДА'; тут изменили первое значение в массиве на "да"
...
let john = {    // Мы хотим сказать, что глобальный класс здесь soldier, а john - это потомок.
    health: 100
};

john.__proto__=soldier; //Здесь мы это говорим, что это потомок 

console.log(john);
console.log(john.armor); //Мы увидим здесь 100 armor. Команда ищет сначала значение внутри john-а, не находит, идет в его прототип, а там находит.
// Это и есть объектно ориентированное программирование 