...
alert("Добро пожаловать на страницу с расчетом Вашего бюджета. Страница максимально бесполезная и безопасная, но за то сможете поиграть с числами и наглядно посмотреть Ваш бюджет. Эта программа работает в режиме тестирования. Все ошибки вы можете присылать на Вотсапп - 79270733739.");

let iq = prompt("Внимание введите любую букву или цифры. Если Ваш IQ меньше 10 - введите цифру 1");
if (iq == 1) {
    alert("Хах - ЛОХ");
};
